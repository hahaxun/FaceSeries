...
configurations = {
    1: dict(
        ...
        BACKBONE_RESUME_ROOT = '/home/lvtingxun/Project/Classy/content_search_engine/frontend/encoders/face_encoder/model_data/backbone_ir50_asia.pth', # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT = '/home/lvtingxun/Project/Classy/content_search_engine/frontend/encoders/face_encoder/model_data/backbone_ir50_asia.pth', # the root to resume training from a saved checkpoint
